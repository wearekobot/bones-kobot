...
function bones_excerpt_more($more) {
	...
	return '...  <a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __('Read', 'bonestheme') . the_title_attribute(array('post' => $post->ID, 'echo' => false)).'">'. __('Read more &raquo;', 'bonestheme') .'</a>';
}
